...
<body>
            ...
            <div class="container-xl">
                <div class="row g-2  mb-5 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                           <a href="#" class="btn btn-info d-none d-sm-inline-block"  data-bs-toggle="modal" data-bs-target="#modalproveedor">
                ...
                <div class="card">
                  ...
                  <div class="table-responsive m-4">
                    <table id="proveedor_data"  class="table card-table table-vcenter text-nowrap datatable">
                      <thead>
                        <tr>
    ...
    <script type="text/javascript" src="adminproveedor.js"></script>
</body>
</html>
<?php
  }else{
