...
<header class="navbar navbar-expand-md navbar-overlap d-print-none" data-bs-theme="dark" >
    <div class="container-xl">
        ...
        <div class="dropdown-menu-arrow">
            <div class=" dropdown-item nd-lg-inline-block ms-3">Municipalidad</div>
            <div class=" dropdown-item d-lg-inline-block ms-3">Provincial de Chiclayo</div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-menu ">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch justify-content-end  align-items-md-center">
