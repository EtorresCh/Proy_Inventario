...
<body>
            ...
            <div class="container-xl">
                <div class="row g-2  mb-5 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="#" class="btn btn-info d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modalequipo">
    ...
    <?php require_once 'modalequipo.php';?>
    <?php require_once '../html/MainJs.php';?>
    <script type="text/javascript" src="adminequipo.js"></script>
