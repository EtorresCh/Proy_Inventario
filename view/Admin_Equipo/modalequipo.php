<div class="modal modal-blur fade" id="modalequipo" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
            <div class="mb-3">
                <label class="form-label">Ubicacion:<span style="color:red"> *</span></label>
